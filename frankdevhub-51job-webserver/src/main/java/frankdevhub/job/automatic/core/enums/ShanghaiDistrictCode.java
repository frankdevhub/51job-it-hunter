...
public enum ShanghaiDistrictCode {
     ...
     * @reutrn 辖区对象
     */
    public static ShanghaiDistrictCode getInstance(String name) {
        Assert.notNull(name, "cannot find name");
        for (ShanghaiDistrictCode c : ShanghaiDistrictCode.values()) {
     ...
     * @reutrn 辖区对象
     */
    public static ShanghaiDistrictCode getInstance(Integer code) {
    ...
    private ShanghaiDistrictCode(String name, Integer code) {
        this.name = name;
        this.code = code;
    }
