package frankdevhub.job.automatic.core.data.logging;

import frankdevhub.job.automatic.core.message.logging.ConsoleSender;
import frankdevhub.job.automatic.core.message.logging.ELoggerImpl;
