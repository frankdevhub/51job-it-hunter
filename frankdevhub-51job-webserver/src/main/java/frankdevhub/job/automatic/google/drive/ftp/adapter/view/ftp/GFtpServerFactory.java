...
public class GFtpServerFactory extends FtpServerFactory {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(GFtpServerFactory.class);
    ...
    public GFtpServerFactory(Controller controller, Cache model, Properties configuration,
        ...
        LOGGER.begin().info("Configured illegalchars '" + illegalChars + "'");
        init();
    }
    ...
    private void init() {
        ...
        LOGGER.begin().info("FTP server configured at '" + serverAddress + ":" + port + "'");
